    ...
    <aside id="savoye-aside">
        ...
        <div class="savoye-logo">
            <a class="logo" href="<?php echo esc_url(home_url('/')); ?>"> 
                <?php if(isset($savoye_redux_demo['logo_sidebar_dark']['url']) && $savoye_redux_demo['logo_sidebar_dark']['url'] != ''){ ?>
                    <img src="<?php echo esc_url($savoye_redux_demo['logo_sidebar_dark']['url']); ?>" class="logo-img" alt="">
                <?php }else{ ?>
        ...
        <nav class="savoye-main-menu">
            <?php 
                  ...
                  array( 
                        ...
                        'walker'            => new savoye3_wp_bootstrap_navwalker(),
                        'before'          => '',
                        'after'           => '',
                        'link_before'     => '',
                        'link_after'      => '',
