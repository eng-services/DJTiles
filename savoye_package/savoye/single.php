...
<?php  if ($post_select=='light') { ?>
  ...
  ?>
  <!-- Header Banner -->
  <?php if(isset($savoye_redux_demo['blog_details_banner_image']['url']) && $savoye_redux_demo['blog_details_banner_image']['url'] != ''){?>
  <div class="banner-header section-padding valign bg-img bg-fixed" data-overlay-dark="4" data-background="<?php echo esc_url($savoye_redux_demo['blog_details_banner_image']['url']); ?>">
  <?php }else{ ?>
      ...
      <div class="container">
          <div class="row">
              <div class="col-md-12 text-center caption mt-90">
                  <h1><?php if(isset($savoye_redux_demo['blog_details_title'])){?>
                      <?php echo wp_specialchars_decode(esc_attr($savoye_redux_demo['blog_details_title']));?>
                      <?php }else{?>
                      <?php echo esc_html__( 'Blog Single', 'savoye' );
                      }
                      ?>
                  </h1>
              </div>
  ...
  <?php }elseif($post_select=='lightsidebar'){ ?>
  <?php
     $savoye_redux_demo = get_option('redux_demo');
  ...
  ?>
  <?php }elseif($post_select=='darksidebar'){ ?>
  <?php
     $savoye_redux_demo = get_option('redux_demo');
