    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center caption mt-90">
                <h1>
                  <?php printf( esc_html__( 'Search Results', 'savoye' ), get_search_query() ); ?> 
                </h1>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        ...
                        <?php endwhile; else :?>
                          <div class="search-custom" >
                            ...
                            echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'savoye' ) ;?>
                            </h4>
                            <?php get_search_form();?>
                          </div>
                        <?php endif;?>
