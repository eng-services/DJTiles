<?php
/*
 * Template Name: Blog Dark Sidebar Style 1
    ...
    <div class="container">
        <?php  $i =0;
            $args = array(    
                    'paged' => $paged,
                    'post_type' => 'post',
                    'post__in' => array(353,351,349,347,17,118,120,122),
            );
        ...
        <?php endwhile; ?>
        <div class="row">
            <div class="col-md-12 text-center animate-box mb-30 mt-60" data-animate-effect="fadeInUp">
