        ...
        <div class="container">
            ...
            <div class="logo-wrapper">
                <a class="logo" href="<?php echo esc_url(home_url('/')); ?>"> 
                    <?php if(isset($savoye_redux_demo['logo_dark']['url']) && $savoye_redux_demo['logo_dark']['url'] != ''){ ?>
                    <img src="<?php echo esc_url($savoye_redux_demo['logo_dark']['url']); ?>" alt="">
                    <?php }else{ ?>
