                    ...
                    <div class="item abot">
                        <div class="logo mb-15"> 
                            <a href="<?php echo esc_url(home_url('/')); ?>"> 
                                <?php if(isset($savoye_redux_demo['footer_logo_dark']['url']) && $savoye_redux_demo['footer_logo_dark']['url'] != ''){ ?>
                                <img src="<?php echo esc_url($savoye_redux_demo['footer_logo_dark']['url']); ?>" alt="">
                                <?php }else{ ?>
