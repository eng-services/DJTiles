        ...
        <div class="row">
            <div class="col-md-12 text-center caption mt-90">
                <h1>
                  <?php
                        if ( is_day() ) :
                            printf( esc_html__( 'Daily Archives : %s', 'savoye' ), get_the_date() );
                        elseif ( is_month() ) :
                            printf( esc_html__( 'Monthly Archives: %s', 'savoye' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'savoye' ) ) );
                        elseif ( is_year() ) :
                            printf( esc_html__( 'Yearly Archives: %s', 'savoye' ), get_the_date( _x( 'Y', 'yearly archives date format', 'savoye' ) ) );
                        else :
                            echo esc_html__( 'Archives', 'savoye' );
                        endif;
                      ?>
                </h1>
            </div>
