...
?>
<?php $service_select = get_post_meta(get_the_ID(),'_cmb_service_select', true); ?>
<?php  if ($service_select == 'light') { ?>
  <?php
     $savoye_redux_demo = get_option('redux_demo');
     get_header(); 
  ?>
  <!-- Header Banner -->
  <?php if(isset($savoye_redux_demo['service_details_banner_image']['url']) && $savoye_redux_demo['service_details_banner_image']['url'] != ''){?>
  <div class="banner-header section-padding valign bg-img bg-fixed" data-overlay-darkgray="4" data-background="<?php echo esc_url($savoye_redux_demo['service_details_banner_image']['url']); ?>">
  <?php }else{ ?>
  <div class="banner-header section-padding valign bg-img bg-fixed" data-overlay-darkgray="4" data-background="<?php echo get_template_directory_uri();?>/img/slider/1.jpg">
  <?php }?>
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center caption mt-90">
                    <h1><?php the_title(); ?></h1>
                    <h5><a href="#">
                      <?php if(isset($savoye_redux_demo['service_details_item'])){?>
                      <?php echo wp_specialchars_decode(esc_attr($savoye_redux_demo['service_details_item']));?>
                      <?php }else{?>
                      <?php echo esc_html__( 'Services', 'savoye' );
                      }
                      ?></a> / <?php the_title(); ?></h5>
                </div>
            </div>
                        ...
                        <div class="sidebar-widget services">
                            <div class="widget-inner">
                                <div class="sidebar-title">
                                    <h5><?php if(isset($savoye_redux_demo['service_menu_title'])){?>
                                      <?php echo wp_specialchars_decode(esc_attr($savoye_redux_demo['service_menu_title']));?>
                                      <?php }else{?>
                                      <?php echo esc_html__( 'All Services', 'savoye' );
                                      }
                                      ?></h5>
                                </div>
                                <?php 
                                  ...
                                  array( 
                                        ...
                                        'walker'            => new savoye2_wp_bootstrap_navwalker(),
                                        'before'          => '',
                                        'after'           => '',
                                        'link_before'     => '',
                                        'link_after'      => '',
  ...
  <?php } elseif($service_select == 'dark') { ?>
  <?php
     $savoye_redux_demo = get_option('redux_demo');
     get_header('dark'); 
  ?>
  ...
  <?php } elseif($service_select == 'lightsidebar') { ?>
  <?php
     $savoye_redux_demo = get_option('redux_demo');
                    ...
                    <aside class="sidebar blog-sidebar">
                        <div class="sidebar-widget services">
                            <div class="widget-inner">
                                <div class="sidebar-title">
                                    <h5>
                                      <?php if(isset($savoye_redux_demo['service_menu_title'])){?>
                                      <?php echo wp_specialchars_decode(esc_attr($savoye_redux_demo['service_menu_title']));?>
                                      <?php }else{?>
                                      <?php echo esc_html__( 'All Services', 'savoye' );
                                      }
                                ...
                                <?php 
                                  wp_nav_menu( 
                                  array( 
                                        'theme_location' => 'service_lightsidebar',
                                        'container' => '',
                                        'menu_class' => '', 
                                        'menu_id' => '',
                                        'menu'            => '',
                        ...
                        <div class="sidebar-widget services">
                            <div class="widget-inner">
                                ...
                                <?php 
                                  wp_nav_menu( 
                                  array( 
                                        'theme_location' => 'service_darksidebar',
                                        'container' => '',
                                        'menu_class' => '', 
                                        'menu_id' => '',
                                        'menu'            => '',
